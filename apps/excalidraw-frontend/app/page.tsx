...
function App() {
  ...
  const handleJoinRoom = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const validateResponse = await fetch(`${HTTP_BACKEND}/room/validate-room`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Create a room with a custom name or join an existing one</p>
            </div>
            ...
            <form onSubmit={handleCreateRoom} className="mb-6">
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) => handleRoomInputChange('createRoomName', e.target.value)}
            ...
            <form onSubmit={handleJoinRoom} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleRoomInputChange('roomId', e.target.value)}
          ...
          <section className="px-4 py-20">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                Create, collaborate, and bring your ideas to life with our powerful online whiteboard. 
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                  ...
                  <p className="text-gray-600">
                    Work together in real-time with your team members from anywhere in the world.
                  </p>
                </div>
                <div className="text-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div className="text-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                  ...
                  <p className="text-gray-600">
                    Your data is encrypted and secure. Full control over who can access your boards.
                  </p>
                </div>
              </div>
            </div>
